    ...
    std::vector<Eigen::Vector3d>& voxels)
{
    ...
    sbpl::geometry::VoxelizeSphere(radius, pose, res, go, voxels, false);
    return true;
}
    ...
    std::vector<Eigen::Vector3d>& voxels)
{
    ...
    sbpl::geometry::VoxelizeCylinder(radius, height, pose, res, go, voxels, false);
    return true;
}
    ...
    std::vector<Eigen::Vector3d>& voxels)
{
    ...
    sbpl::geometry::VoxelizeCone(radius, height, pose, res, go, voxels, false);
    return true;
}
    ...
    std::vector<Eigen::Vector3d>& voxels)
{
    ...
    sbpl::geometry::VoxelizeBox(length, width, height, pose, res, go, voxels, false);
    return true;
}
    ...
    std::vector<Eigen::Vector3d>& voxels)
{
    ...
    sbpl::geometry::VoxelizeMesh(vertices, indices, pose, res, go, voxels, false);
    return true;
}
    ...
    std::vector<Eigen::Vector3d>& voxels)
{
    ...
    std::vector<Eigen::Vector3d> sbpl_voxels;
    sbpl::geometry::VoxelizeSphere(radius, eigen_pose, res, go, sbpl_voxels, false);
    ...
    std::vector<Eigen::Vector3d>& voxels)
{
    ...
    std::vector<Eigen::Vector3d> sbpl_voxels;
    sbpl::geometry::VoxelizeCylinder(
    ...
    std::vector<Eigen::Vector3d>& voxels)
{
    ...
    std::vector<Eigen::Vector3d> sbpl_voxels;
    sbpl::geometry::VoxelizeCone(radius, height, eigen_pose, res, go, sbpl_voxels, false);
    ...
    std::vector<Eigen::Vector3d>& voxels)
{
    ...
    std::vector<Eigen::Vector3d> sbpl_voxels;
    sbpl::geometry::VoxelizeMesh(vertices, indices, eigen_pose, res, go, sbpl_voxels, false);
